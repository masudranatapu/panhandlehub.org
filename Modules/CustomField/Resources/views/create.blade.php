            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('create_custom_field') }}</h3>
                        <div>
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <form class="form-horizontal" action=" {{ route('module.custom.field.store') }}"
                                method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="type"
                                                ...
                                                <option {{ old('type') == 'checkbox' ? 'selected' : '' }}
                                                ...
                                                <div class="icheck-success">
                                                    ...
                                                    <x-forms.label name="required" :required="false"
                                                        ...
                                                        <span data-toggle="tooltip"
                                                            title="must be filled when attaching the field with any ad.">
                                                            <x-svg.info-icon />
                                                        </span>
                                                    </x-forms.label>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="icheck-success">
                                                    ...
                                                    <x-forms.label name="listable" :required="false"
                                                        ...
                                                        <span data-toggle="tooltip"
                                                            title="Use this field to show in the ad list.">
                                                            <x-svg.info-icon />
                                                        </span>
                                                    </x-forms.label>
                                                </div>
