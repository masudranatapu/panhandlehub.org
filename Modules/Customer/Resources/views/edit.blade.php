            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('edit_customer') }}</h3>
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-6 offset-md-3">
                            ...
                            <form class="form-horizontal"
                                action="{{ route('module.customer.update', $customer->username) }}" method="POST"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <x-forms.input type="text" name="name" value="{{ $customer->name }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <x-forms.input type="text" name="username" value="{{ $customer->username }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <x-forms.input type="email" name="email" value="{{ $customer->email }}"
                                            placeholder="email" />
                                    </div>
                                </div>
                                <div class="form-group row">
