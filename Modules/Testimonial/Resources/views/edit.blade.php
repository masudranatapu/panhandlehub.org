                    ...
                    <div class="row pt-3 pb-3">
                        <div class="col-6 offset-md-3 text-center">
                            @if ($testimonial->image)
                                <img class="rounded m-auto p-3 border" id="image" width="150px" height="150px" src=" {{ asset($testimonial->image) }}" alt="user image">
                            @else
                                    ...
                                    <div class="col-sm-9 d-flex">
                                        @foreach ($app_languages as $lang)
                                            <div class="custom-control custom-radio mr-3">
                                                <input class="custom-control-input" type="radio" id="lang_code_{{ $lang->id }}" name="code" {{ $lang->code == $testimonial->code ? 'checked':'' }} value="{{ $lang->code }}">
