    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title line-height-36">{{ __('offline_payment_methods') }}</h3>
                </div>
        ...
        <div class="col-md-4">
            @if (!empty($manual_payment))
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title line-height-36">{{ __('edit') }} {{ __('payment') }}</h3>
            ...
            @if (empty($manual_payment))
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title line-height-36">{{ __('create') }} {{ __('payment') }}</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control text-capitalize" id="contact-modal-type" readonly>
                        </div>
                        <div class="form-group">
...
@section('script')
    ...
    <script>
        ...
        function contactDetail(contact) {
            ...
            $('#contact-modal-type').val(contact.type.replace('_', ' '));
