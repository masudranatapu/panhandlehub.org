...
@section('content')
    <div class="desktop_view d-none d-md-block">
        ...
        <div class="ads mt-5 mb-5">
            <div class="container">
                <a href="#" target="_blank">
                    <img src="{{ asset('frontend/images/ads/horizontal.png') }}" alt="logo">
                </a>
            </div>
        </div>
        {{-- ads --}}
                    ...
                    <div class="category_item mb-4">
                        <ul>
                            @foreach ($item->subcategories as $scat)
                                <li>
                                    <a
                                        href="{{ route('frontend.search', ['category' => $item->slug, 'subcategory' => $scat->slug]) }}">{{ __($scat->name) }}
                                        |
                                    </a>
                                </li>
                            @endforeach
        ...
        <div class="ads mt-5 mb-5">
            <div class="container">
                <a href="#" target="_blank">
                    <img src="{{ asset('frontend/images/ads/horizontal.png') }}" class="" alt="logo">
                </a>
            </div>
        </div>
        {{-- ads --}}
