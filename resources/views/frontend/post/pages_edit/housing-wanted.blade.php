            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-1">
                        <label for="fee_detailed" class="form-label">detailed fee description
                            please</label>
                        <input type="text" name="fee_detailed" value="{{ $ad->fee_detailed }}" id="application_fee_detailed"
                            class="form-control" disabled>
                    </div>
                </div>
            </div>
