<div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="mb-1">
                            ...
                            <select name="condition" id="condition" class="form-control">
                                ...
                                <option value="like new" {{ $ad->conditions == "like new" ? "selected" : ""}}>like new
                                </option>
                                <option value="excellent" {{ $ad->conditions == "excellent" ? "selected" :
                                    ""}}>excellent</option>
                                <option value="good" {{ $ad->conditions == "good" ? "selected" : ""}}>good</option>
                                <option value="fair" {{ $ad->conditions == "fair" ? "selected" : ""}}>fair</option>
                                <option value="salvage" {{ $ad->conditions == "salvage" ? "selected" : ""}}>salvage
                                </option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="services[]" value="delivery available"
                            id="delivery_available" {{ isset($ad->services) && in_array('delivery
                        available',$ad->services)? "checked" : "" }}>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="services[]"
                            value="include more ads by this user link" id="include_more" {{ isset($ad->services) &&
                        in_array('include more ads by this user link',$ad->services)? "checked" : "" }}>
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            ...
                            "panhandlehub mail relay" ? "checked" : "" }} id="privacy_1"
    ...
    <div class="col-12">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="term_condition" {{ $ad->other_contact ? "checked" : ""
