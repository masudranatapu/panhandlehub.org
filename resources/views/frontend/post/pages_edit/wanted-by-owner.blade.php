            ...
            <div class="row mb-3">
                <div class="col-lg-4">
                    <div class="mb-1">
                        ...
                        <input type="text" name="dimension" id="dimension" value="{{ $ad->dimension ?? old('dimension') }}"      class="form-control" placeholder="length x width x height">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="col-lg-10">
                        <div class="mb-1">
                            ...
                            <select name="condition" id="condition" class="form-control">
                                ...
                                <option value="excellent" {{ $ad->condition == "excellent"? "selected" : "" }}>excellent</option>
                                <option value="good" {{ $ad->condition == "good"? "selected" : "" }}>good</option>
                                <option value="fair" {{ $ad->condition == "fair"? "selected" : "" }}>fair</option>
                                <option value="salvage" {{ $ad->condition == "salvage"? "selected" : "" }}>salvage</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-1">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="services[]" value="include more ads by this user link"
