        ...
        <div class="form_wrapper">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="select_dropdown">
                        ...
                        <select name="houssing_type" id="houssing_type" class="form-control">
                            <option value="apartment" {{ $ad->houssing_type == "apartment" ? "selected" : ""}}>apartment</option>
                            <option value="condo" {{ $ad->houssing_type == "condo" ? "selected" : ""}}>condo</option>
                            <option value="cotage/cabin" {{ $ad->houssing_type == "cotage/cabin" ? "selected" : ""}}>cotage/cabin</option>
                            ...
                            <option value="townhouse" {{ $ad->houssing_type == "townhouse" ? "selected" : ""}}>townhouse</option>
                            <option value="manufactured" {{ $ad->houssing_type == "manufactured" ? "selected" : ""}}>manufactured</option>
                            <option value="assisted living" {{ $ad->houssing_type == "assisted living" ? "selected" : ""}}>assisted living</option>
                        </select>
                    </div>
                    <div class="select_dropdown">
                        ...
                        <select name="laundry" id="laundry" class="form-control">
                            ...
                            <option value="w/d in unit" {{  $ad->laundry == "w/d in unit"? "selected" : "" }}>w/d in unit</option>
                            <option value="w/d hookups" {{  $ad->laundry == "w/d hookups"? "selected" : "" }}>w/d hookups</option>
                            <option value="laundry in bldg" {{  $ad->laundry == "laundry in bldg"? "selected" : "" }}>laundry in bldg</option>
                            <option value="laundry on site" {{  $ad->laundry == "laundry on site"? "selected" : "" }}>laundry on site</option>
                            <option value="no lanudry on site" {{  $ad->laundry == "no lanudry on site"? "selected" : "" }}>no lanudry on site</option>
                        </select>
                    </div>
                    <div class="select_dropdown">
                        ...
                        <select name="parking" id="parking" class="form-control">
                            ...
                            <option value="attached garage" {{ $ad->parking == "attached garage"? "selected" : "" }}>attached garage</option> 
                            <option value="detached garage" {{ $ad->parking == "detached garage"? "selected" : "" }}>detached garage</option>
                            <option value="off-street parking" {{ $ad->parking == "off-street parking"? "selected" : "" }}>off-street parking</option>
                            <option value="street parking" {{ $ad->parking == "street parking"? "selected" : "" }}>street parking</option>
                            <option value="valet parking" {{ $ad->parking == "valet parking"? "selected" : "" }}>valet parking</option>
                            <option value="no parking" {{ $ad->parking == "no parking"? "selected" : "" }}>no parking</option>
                        </select>
                    </div>
                    <div class="select_dropdown">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="services[]"
                        {{ isset($ad->services) && in_array('furnished',$ad->services)? "checked" : "" }}
                            id="furnished" value="furnished">
                        <label class="form-check-label" for="furnished">furnished</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="services[]"
                        {{ isset($ad->services) && in_array('no smoking',$ad->services)? "checked" : "" }}
                            id="no_smoking" value="no smoking">
                        <label class="form-check-label" for="no_smoking">no smoking</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="services[]"
                        {{ isset($ad->services) && in_array('wheelchair accessible',$ad->services)? "checked" : "" }}
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="services[]"
                        {{ isset($ad->services) && in_array('air conditioning',$ad->services)? "checked" : "" }}
                            id="air_conditioning" value="air conditioning">
                        <label class="form-check-label" for="air_conditioning">air conditioning</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="services[]"
                        {{ isset($ad->services) && in_array('EV charging',$ad->services)? "checked" : "" }}
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="mb-3">
                        ...
                        <input type="date" name="available_on" {{ date('d M Y',strtotime($ad->available_on)) }} id="available_on" class="form-control">
                    </div>
                </div>
            </div>
        </div>
