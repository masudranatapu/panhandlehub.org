<div class="row">
    <div class="col-12 mb-4">
        <div class="form_wrapper availability_check">
            ...
            <div class="form-check me-3">
                <input class="form-check-input" type="checkbox" name="availability[]" {{ isset($ad->availability) &&
                in_array('morning',$ad->availability)? "checked" : "" }}
            ...
            <div class="form-check me-3">
                <input class="form-check-input" type="checkbox" name="availability[]" {{ isset($ad->availability) &&
                in_array('afternoon',$ad->availability)? "checked" : "" }}
            ...
            <div class="form-check me-3">
                <input class="form-check-input" type="checkbox" name="availability[]" {{ isset($ad->availability) &&
                in_array('evening',$ad->availability)? "checked" : "" }}
            ...
            <div class="form-check me-3">
                <input class="form-check-input" type="checkbox" name="availability[]" {{ isset($ad->availability) &&
                in_array('overnight',$ad->availability)? "checked" : "" }}
            ...
            <div class="form-check me-3">
                <input class="form-check-input" type="checkbox" name="availability[]" {{ isset($ad->availability) &&
                in_array('weekdays',$ad->availability)? "checked" : "" }}
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="availability[]" {{ isset($ad->availability) &&
                in_array('weekends',$ad->availability)? "checked" : "" }}
    ...
    <div class="col-12 mb-4">
        <div class="form_wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="education" id="education" class="form-control" required>
                            ...
                            <option value="less than high school" {{ $ad->education == "less than high school"?
                                "selected" : ""}}>less than high school</option>
                            <option value="high school/GED" {{ $ad->education == "high school/GED"? "selected" :
                                ""}}>high school/GED</option>
                            <option value="some college" {{ $ad->education == "some college"? "selected" : ""}}>some
                                college</option>
                            <option value="associates" {{ $ad->education == "associates"? "selected" : ""}}>associates
                            </option>
                            <option value="bachelors" {{ $ad->education == "bachelors"? "selected" : ""}}>bachelors
                            </option>
                            <option value="masters" {{ $ad->education == "masters"? "selected" : ""}}>masters</option>
                            <option value="doctoral" {{ $ad->education == "doctoral"? "selected" : ""}}>doctoral
                            </option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="direct_contact" {{ $ad->direct_contact?
                        "checked" : "" }}
    ...
    <div class="col-12 mb-3">
        <div class="form-check me-3" style="display:inline-block;">
            <input class="form-check-input" type="radio" name="is_license" id="unlicensed" {{ $ad->is_license == 0?
            "checked" : "" }}
            value="0" checked>
        ...
        <div class="form-check me-3" style="display:inline-block;">
            <input class="form-check-input" type="radio" name="is_license" id="licensed" {{ $ad->is_license == 1?
            "checked" : "" }}
            value="1">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="license_info" id="license_info" value="{{ $ad->license_info}}" class="form-control"
                disabled>
        </div>
    </div>
