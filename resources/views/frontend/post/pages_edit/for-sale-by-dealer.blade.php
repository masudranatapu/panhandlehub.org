        ...
        <div class="form_wrapper">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-1">
                        <label for="language" class="form-label"><small class="text-success">language of
                                posting <small class="text-danger">*</small></small></label>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="services[]"
                            value="include more ads by this user link"
    ...
    <div class="col-12">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="term_condition" name="other_contact"
                value="1"{{ $ad->other_contact == "1"? 'checked' : '' }} required>
