...
class SocialiteController extends Controller
{
    ...
    public function updateStatus(Request $request)
    {
        ...
        switch ($type) {
            case 'google':
                setEnv('GOOGLE_LOGIN_ACTIVE', $status ? 'true' : 'false');
                break;
            case 'facebook':
                setEnv('FACEBOOK_LOGIN_ACTIVE', $status ? 'true' : 'false');
                break;
            case 'twitter':
                setEnv('TWITTER_LOGIN_ACTIVE', $status ? 'true' : 'false');
                break;
            case 'linkedin':
                setEnv('LINKEDIN_LOGIN_ACTIVE', $status ? 'true' : 'false');
                break;
            case 'github':
                setEnv('GITHUB_LOGIN_ACTIVE', $status ? 'true' : 'false');
                break;
        }
